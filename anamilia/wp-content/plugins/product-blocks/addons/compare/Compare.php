...
class Compare {
	 ...
	 */
    public function compare_shortcode_callback($ids = array(), $params = []) {
        $html = '';
    ...
    public function wopb_compare_callback() {
        ...
        if ( $postId && $type ) {
            ...
            $html = (wopb_function()->get_setting('compare_action_added') != 'redirect') ? $this->compare_shortcode_callback($data_id, $params) : '';

...
class Caches{
    ...
    public function check_premade_sync() {
        $wopb_premade_data_fetched = get_transient( 'wopb_premade_data_fetched' );
        if($wopb_premade_data_fetched !== 'wopb_premade_data_fetched') {
            $this->fetch_all_design_callback([]);
        }
    }
    ...
    public function fetch_all_design_callback($request) {
        set_transient( 'wopb_premade_data_fetched', 'wopb_premade_data_fetched', 432000);   // 5 days
        $test = '';
